...
import { OutputFormat, OutputService } from 'src/output/output.service';
...
export class SmtpService {
  ...
  hasCode(message: Buffer, code: keyof typeof ErrorCodes): boolean {
    return (
  ...
  checkSMTP(
    ...
    return new Promise((r) => {
      ...
      socket.once('fail', (msg) => {
        socketClosed = true;
        r(this.outputService.createOutput('smtp', msg));
      ...
      socket.on('success', () => {
        ...
        r(this.outputService.createOutput());
      });
